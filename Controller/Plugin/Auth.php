 ...
 *
 * @category    CG
 * @package     CG_Controller
 * @subpackage  CG_Controller_Plugin
 * @version     0.0.1
 * @author      chancegarcia.com
 * @license     http://www.opensource.org/licenses/lgpl-3.0.html
 */
class CG_Controller_Plugin_Auth extends
    Zend_Controller_Plugin_Abstract
{
    ...
    {
        throw Exception(
            'use all the methods we made in here aka tie it
all together for deployment'
    ...
    public function setAcl($acl = null)
    {
        ...
        {
            throw new CG_Controller_Plugin_Auth_Exception(
                "please provide an instance of Zend_Acl",

                CG_Controller_Plugin_Auth_Exception::INVALID_TYPE
            );
        }
...
bootstrap under the appropriate key.",
                    ...
                    CG_Controller_Plugin_Auth_Exception::MISSING_ACL,
                    $ze
                );
            }
        }
...
module,controller,action",
                ...
                CG_Controller_Plugin_Auth_Exception::MISSING_DATA
            );
        }
